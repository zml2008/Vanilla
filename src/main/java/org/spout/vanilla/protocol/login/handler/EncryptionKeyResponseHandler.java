...
import org.spout.vanilla.protocol.login.msg.EncryptionKeyResponseMessage;
		...
		if (state == Session.State.EXCHANGE_HANDSHAKE) {
			...
			Runnable runnable = new Runnable() {
				public void run() {
					...
					LoginSuccessMessage response = new LoginSuccessMessage(UUID.randomUUID(), finalName);
